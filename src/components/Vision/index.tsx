...
function Vision() {
  ...
  // const text = new SplitType("#text_1")
  // console.log(text.chars)
    ...
    const trans = () => {
       const sticky = document.querySelector('.sticky_1')
       const offSetTop = sticky?.parentElement?.offsetTop
      const scrollSection = sticky?.querySelector('.char')
    }
    ...
    <div className="bg-fixed bg-black bg-right-bottom bg-no-repeat bg-cover bg-vision-bg-mobile md:bg-vision-bg-tablet lg:bg-vision-bg">
      ...
      <div className='h-[600vh]'>
        <div className="sticky sticky_2 overflow-hidden top-0 h-[100vh]">
          <div className='absolute top-0 scroll_section h-[100%] w-[600vw] will-change-transform flex'>
            <div  className="z-10 bg-no-repeat bg-cover bg-L3">
                      ...
                      <div  className="w-screen text-white bg-black lg:bg-transparent font-Outfit">
                        <div className="relative flex items-center justify-center h-full">
                          ...
                          <div  ref={observe} className="flex flex-col items-center justify-center right-2 top-48">
                              <p id='text_1' className={inView ? "text-4xl font-extrabold text-center  ease-in delay-500 transition-opacity": "text-4xl font-extrabold text-center opacity-25"}>We want to put the power of Web3 in</p>
                              <p id='text_2' className={inView ? "text-4xl font-extrabold text-center  ease-in delay-500 transition-opacity": "text-4xl font-extrabold text-center opacity-25"}>the hands of billons, so we created</p>
                              <p  id='text_3' className={inView ? "text-4xl font-extrabold text-center ease-in delay-700 transition-opacity": "text-4xl font-extrabold text-center opacity-25"}>TowneSquare</p>
