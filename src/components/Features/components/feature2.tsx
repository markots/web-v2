...
import 'animate.css'
import { AnimateText } from "./Animationstyle";
    ...
    return (
        ...
        >
            <div className=" flex flex-col md:flex-col  flex-grow-1 justify-center  relative w-full items-center">
                ...
                <AnimateText>
                    <div className=" pr-96 mt-16">  <img  src="/images/features/text_anywhere.svg" alt="anywhere" />  </div>
                    ...
                    <div className="flex z-1 flex-col items-center mb-20 -mt-40">
                        {isMobileView ? (
                            <div className="md:mx-8 lg:mx-8 lg:w-1/3 md:w-1/2">
                                <img className="w-full" src="/images/features/m_features5.svg" alt="Self-bank" />
                            </div>
                        ) : (
                            <img className="w-full" src="/images/features/features5.svg" alt="Self-bank" />
                        )}
                    </div>
                ...
                <AnimateText>
                    <div className=" mb-16 pl-80">  <img  src="/images/features/spend_social.svg" alt="spend social" />  </div>
            ...
            <div className=" flex flex-col md:flex-col  flex-grow-1 justify-center  relative w-full items-center">
                ...
                <AnimationOnScroll duration={2} animateIn="animate__fadeInRightBig" animateOut="animate__fadeInLeftBig">
                    ...
                    <div className="flex z-1 flex-col items-center mb-20 -mt-40">
                        {isMobileView ? (
                            <div className="md:mx-8 lg:mx-8 lg:w-1/3 md:w-1/2">
                                <img className="w-full" src="/images/features/m_features6.svg" alt="Discover_new_friends" />
                            </div>
                        ) : (
                            <img className="w-full" src="/images/features/features6.svg" alt="Discover_new_friends" />
                        )}
                    </div>
                ...
                <AnimateText>
                    <div className=" mb-16"> <img  src="/images/features/spend_social.svg" alt="spend social" />  </div>
            ...
            <div className="flex flex-col md:flex-col  flex-grow-1 justify-center  relative w-full items-center ">
                ...
                <AnimateText>
                    <div className="  pr-6 mt-16">   
                    <img  src="/images/features/text_anywhere.svg" alt="anywhere" /> 
                    </div>
            ...
            <div className="flex flex-col md:flex-col  flex-grow-1 justify-center  relative w-full items-center ">
                ...
                <AnimationOnScroll duration={2} animateIn="animate__fadeInRightBig" animateOut="animate__fadeInLeftBig">
                    ...
                    <div className="flex z-1 flex-col items-center mb-20 -mt-20">
                        {isMobileView ? (
                            <div className="md:mx-8 lg:mx-8 lg:w-1/3 md:w-1/2">
                                <img className="w-full" src="/images/features/m_features7.svg" alt="experence_freedom" />
                            </div>
                        ) : (
                            <img className="w-full" src="/images/features/features7.svg" alt="experence_freedom" />
                        )}
                    </div>
                ...
                <AnimateText>
                    <div className=" mb-16 pr-96">  <img  src="/images/features/spend_social.svg" alt="spend social" /> </div>
